    ...
    <main class="mx-auto max-w-3xl px-6 py-10">
        <div
            ...
            <div class="px-5 pb-6 text-center">
                <div class="-mt-12 mx-auto h-24 w-24 rounded-full border-4 border-white/50 bg-white/10 shadow-xl shadow-black/40 overflow-hidden z-10 animate-spin" style="animation-duration: 2s;">
                    @if($user->image)
                ...
                <div class="grid grid-cols-3 gap-2 mx-5 mt-5">
                    @if($user->facebook)
                        <!-- <a href="{{ $user->facebook }}" target="_blank" rel="noopener" class="text-gray-700 border bg-white border-white/10 rounded-full p-1"><i class="fa-brands fa-facebook text-blue-700"></i></a> -->
                    @endif
                    <a href="{{ $user->facebook }}" target="_blank" rel="noopener" class="text-gray-600 border bg-white border-white/10 rounded-full p-1"><i class="fa-brands fa-facebook text-blue-600"></i></a>
                    <a href="{{ $user->facebook }}" target="_blank" rel="noopener" class="text-gray-600 border bg-white border-white/10 rounded-full p-1"><i class="fa-brands fa-facebook text-blue-600"></i></a>
