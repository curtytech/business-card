...
<body class="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 text-slate-100 font-sans selection:bg-amber-400 selection:text-slate-950">
    ...
    <header class="sticky top-0 z-20 border-b border-white/10 backdrop-blur-md">
        <div class="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
            <a href="/" class="flex items-center gap-3">
                <span class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-amber-400 to-yellow-300 shadow-lg shadow-amber-400/20"></span>
    ...
    <!-- Hero -->
    <section class="mx-auto max-w-7xl px-6 pt-16 pb-8 text-center">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/30 hover:bg-white/7 transition">
                <div class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400/20 text-amber-300">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3 7h7l-5.5 4 2.5 7-6-4.5-6 4.5 2.5-7L2 9h7z"/></svg>
                </div>
            ...
            <div class="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/30 hover:bg-white/7 transition">
                <div class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400/20 text-amber-300">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3a9 9 0 100 18 9 9 0 000-18zm-1 13l-4-4 1.41-1.41L11 12.17l4.59-4.58L17 9z"/></svg>
                </div>
            ...
            <div class="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/30 hover:bg-white/7 transition">
                <div class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400/20 text-amber-300">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M5 3h14a2 2 0 012 2v4H3V5a2 2 0 012-2zm-2 8h18v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6z"/></svg>
                </div>
            ...
            <div class="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/30 hover:bg-white/7 transition">
                <div class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400/20 text-amber-300">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M21 8V7l-3 2-2-1-4 3-3-2-4 3v6h16V8z"/><path d="M5 8l7-5 7 5"/></svg>
                </div>
            ...
            <div class="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/30 hover:bg-white/7 transition">
                <div class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400/20 text-amber-300">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12a5 5 0 100-10 5 5 0 000 10zm0 2c-5 0-9 2.5-9 5.5V22h18v-2.5C21 16.5 17 14 12 14z"/></svg>
                </div>
            ...
            <div class="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/30 hover:bg-white/7 transition">
                <div class="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400/20 text-amber-300">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M4 6h16v12H4z"/><path d="M9 6v12"/></svg>
                </div>
            ...
            <div class="px-5 pb-5 text-center">
                ...
                <div class="mt-4 grid gap-2">
                    <a href="#" class="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-100 hover:bg-white/10 hover:-translate-y-0.5 transition">
                        <svg class="h-4 w-4 opacity-90" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3a9 9 0 100 18 9 9 0 000-18zM7 12h10M12 7v10"/></svg>
                        Site Oficial
                    </a>
                    <a href="#" class="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-100 hover:bg-white/10 hover:-translate-y-0.5 transition">
